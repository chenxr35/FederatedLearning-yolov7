...
if __name__ == "__main__":
    ...
    eval_flag           = True
    eval_period         = 10
    map_out_path        = ".temp_map_out/centralized"
    #------------------------------------------------------------------#
    ...
    if True:
        ...
        #----------------------#
        if local_rank == 0:
            eval_callback   = EvalCallback(model, input_shape, anchors, anchors_mask, class_names, num_classes, val_lines, log_dir, Cuda, map_out_path=map_out_path, eval_flag=eval_flag, period=eval_period)
        else:
            eval_callback   = None
